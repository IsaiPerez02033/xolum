          ...
          <div className="space-y-3">
            {proceso.map((p, i) => (
              <Reveal key={p.n} delay={i * 0.08}>
                <div className="group relative flex gap-6 rounded-2xl p-4 transition-colors hover:bg-[var(--surface)]">
                  <div className="relative z-10 flex h-14 w-14 shrink-0 items-center justify-center rounded-full border border-[var(--hair-strong)] bg-[var(--bg)] font-mono text-sm font-semibold text-brand-300 transition-colors group-hover:border-brand-500/50">
                    {p.n}
                  </div>
